...
*
*  This version ported from Arduino.ino and used Enhanced BASIC																			   
...
miker00lz
Oct '13post #7
Good ideas, but I think you are misunderstanding how it works a little bit. I wrote no code of this BASIC interpreter. 
It is a 6502 program that already existed. I only wrote a 6502 CPU emulator that runs this interpreter. 

I would have to do all 6502 memory space read/write to the EEPROM, 
and it could be writing to memory constantly depending on the 6502 machine code being run. 
It may wear out parts of the EEPROM in a matter of seconds actually! :grin:

Besides, the BASIC interpreter I'm emulating is really just a simple demonstration for the core concept, 
the 6502 emulator. 

*
* This was tested on my Arduino and WOKWI
*
* https://wokwi.com/projects/390013861906316289 WOKWI PICO
* https://wokwi.com/projects/389821002893212673 WOKWI Arduino - 6502
